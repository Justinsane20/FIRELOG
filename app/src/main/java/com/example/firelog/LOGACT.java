...
public class LOGACT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l_o_g_a_c_t);
        ...
        btn_login.setOnClickListener(v -> {
            ...
            mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(task -> {
                ...
                {
                    startActivity(new Intent(LOGACT.this, LOGACT.class));
                }
                else
                {
                    Toast.makeText(LOGACT.this,
        ...
        btn_sign.setOnClickListener(v -> startActivity(new Intent(LOGACT.this,MainActivity.class )));
    }
